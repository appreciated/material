...
public class MaterialTheme extends ValoTheme {
    ...
    public static final String TEXTFIELD_CONTRAST = "contrast";
    public static final String COMBOBOX_CONTRAST = "contrast";
    public static final String DATEFIELD_CONTRAST = "contrast";
