...
public class ImmediateUpload extends AbstractTestUI {
     ...
     * (non-Javadoc)
     *
     * @see com.vaadin.tests.components.com.vaadin.uitest.AbstractTestUI#setup(com.vaadin.server.
     * VaadinRequest)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see com.vaadin.tests.components.com.vaadin.uitest.AbstractTestUI#getTestDescription()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see com.vaadin.tests.components.com.vaadin.uitest.AbstractTestUI#getTicketNumber()
     */
    @Override
